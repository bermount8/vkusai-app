...
export default function MealConfirmScreen() {
  ...
  // Mock data for detected food items
  ...
  const addNewItem = () => {
    const newId = (Math.max(...foodItems.map(item => parseInt(item.id))) + 1).toString();
    setFoodItems([
      ...foodItems,
      { 
        id: newId, 
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={[styles.card, isDark && styles.cardDark]}>
          ...
          <TouchableOpacity style={styles.addItemButton} onPress={addNewItem}>
            <FontAwesome name="plus" size={16} color="#007AFF" style={styles.addItemIcon} />
